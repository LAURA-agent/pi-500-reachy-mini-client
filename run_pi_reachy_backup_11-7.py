...
class PiMCPClient:
    ...
    async def handle_speech_motion(self, request):
        ...
        try:
            ...
            # Disable face tracking and reset to neutral before speech
            print(f"[Speech Motion] Disabling face tracking and resetting to neutral")
            self.camera_worker.set_head_tracking_enabled(False)

            # Clear face tracking offsets to ensure we start from true neutral
